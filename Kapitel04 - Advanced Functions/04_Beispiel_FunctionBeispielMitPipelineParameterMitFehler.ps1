<#
 ...
 .Notes
 Das Beispiel funktioniert noch nicht!
#>

function Get-Speicherkosten
{
  param([Parameter(Mandatory=$true, ValueFromPipelineByPropertyName=$true)][String]$Path,
...
# Der Befehl funktioniert aber leider nicht